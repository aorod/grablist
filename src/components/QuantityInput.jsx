  ...
  return (
    <div className={cn(base, style)}>
      <button
        ...
        className="w-8 lg:w-7 self-stretch flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-gray-100 dark:hover:bg-gray-700 disabled:opacity-30 disabled:cursor-not-allowed transition-colors shrink-0"
      >
        <Minus size={11} />
      </button>
      ...
      <input
        ...
        className="w-0 flex-1 text-center text-sm bg-transparent border-none outline-none py-2 lg:py-1"
      />

      <button
        type="button"
        onClick={inc}
        className="w-8 lg:w-7 self-stretch flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors shrink-0"
      >
        <Plus size={11} />
      </button>
    </div>
